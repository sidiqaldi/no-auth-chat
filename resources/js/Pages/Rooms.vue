                    ...
                    <form @submit.prevent="joinRoom">
                        ...
                        <div class="mt-2 flex items-center max-w-sm mx-auto" >
                            ...
                            <button type="submit" class="p-2.5 ms-2 text-sm font-medium text-white rounded-lg border border-primary-700 focus:ring-4 focus:outline-none bg-primary-600 hover:bg-primary-700 focus:ring-primary-800">
                                <span class="text-nowrap">Create/Join</span>
                            </button>
                        </div>

                        <div class="mt-2 flex items-center max-w-sm mx-auto justify-between" >
                            ...
                            <div class="flex items-center mb-4">
                                <Link :href="route('setup.destroy', '1')" method="delete" as="button" type="button" class="ms-2 text-sm font-medium text-gray-300">Change username?</Link>
                            </div>
                        </div>
                    </form>
